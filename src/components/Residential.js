...
import sliderimg1 from '../images/1.webp';
import sliderimg2 from '../images/4.jpg';
import sliderimg3 from '../images/2.jpg';
import { useEffect, useState } from 'react';
import Header from "./Header";
import residentialbanner from '../images/residentialbanner.png';
        ...
        <>
            ...
            <div className="banner-container position-relative">
                ...
                <div className="banner-text"
                    ...
                    <h1 className="fw-bold text-uppercase"> residential projects</h1>
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active " aria-current="about" >
                            <Link className='fwcolor'>RESIDENTIAL</Link>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div className="pt-4 ps-4">
                <Link to="/ongoing" className="banner-button d-inline-block me-3 fw-bold px-3  py-2"
                    style={{ overflow: "hidden", zIndex: "1", transition: "color 0.5s ease", color: "#000" }}>
                    ONGOING PROJECT
                </Link>

                <Link to="/completed" className="banner-button d-inline-block me-3 fw-bold px-3  py-2"
                    style={{ overflow: "hidden", zIndex: "1", transition: "color 0.5s ease", color: "#000" }}>
                    COMPLETED PROJECT
                </Link>
            </div>
...
export function Currentprojectslider() {
